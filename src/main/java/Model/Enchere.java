...
public class Enchere {
    ...
    public static Vector<Enchere>liste(int etat) throws Exception {
        ...
        for (int i = 0; i <all[0].size() ; i++) {
            Enchere enchere=new Enchere(etat,(String) all[1].elementAt(i),(String)all[3].elementAt(i),(String)all[4].elementAt(i),(String) all[5].elementAt(i), (Date) all[1].elementAt(i),(Double) all[6].elementAt(i));
